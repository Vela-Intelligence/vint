...
export interface EscapeHatchProps {
  /** listener under the EXACT event name (custom events) */ [k: `on:${string}`]: (ev: Event) => void
...
export interface HTMLElementEventProps {
  ...
  onauxclick?: (ev: PointerEvent) => void
  onbeforeinput?: (ev: InputEvent) => void
  onbeforematch?: (ev: Event) => void
  ...
  onpointerrawupdate?: (ev: Event) => void
